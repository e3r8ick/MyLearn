...
CREATE TABLE IF NOT EXISTS `Empresa` (
  ...
  `Nombre` varchar(30) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,'De contacto'
  `Apellido` varchar(30) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL, 'De contacto'
  `Email` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL, 'De contacto'
...
CREATE TABLE IF NOT EXISTS `Proyecto` ('Especificar informacion referente al curso y datos del nombre que le de la empresa'
  `idProyecto` int(11) NOT NULL,
  `idEstudiante` int(11) NOT NULL,
  `idProfesor` int(11) NOT NULL,
  ...
  `FechaLimiteOferta` varchar(10) NOT NULL,
